...
def on_key_press(symbol, modifiers):
    if symbol == KEY.P:
        ...
        world.agents_separation_multiplier -= 1.0
    elif symbol == KEY.X:
        world.agents_separation_multiplier += 1.0
    elif symbol == KEY.D:
        world.agents_cohesion_multiplier -= 1.0
    elif symbol == KEY.S:
        world.agents_cohesion_multiplier += 1.0
    elif symbol == KEY.Q:
        world.agents_alignment_multiplier -= 1.0
    elif symbol == KEY.Q:
        world.agents_alignment_multiplier += 1.0
    elif symbol == KEY.G:
        world.agents_wander_force -= 1.0
    elif symbol == KEY.H:
        world.agents_wander_force += 1.0
